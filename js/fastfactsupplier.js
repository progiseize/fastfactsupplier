...
if (jQuery('body').hasClass('fastfactsupplier') && jQuery('body').hasClass('saisie')) {
    ...
    jQuery('#creafact-redirect').change(function(){
        if(this.checked) { jQuery('.redirect-active').show();}
        else { jQuery('.redirect-active').hide(); }
    });
    ...
    jQuery('#add-facture-line').on('click',function(e){
        ...
        jQuery.ajax({
            ...
            success:function(view){
                ...
                jQuery('.linefact select.pdx').each(function(e){
...
/////////////////////////////////////////////////////////////////////////////////
if (jQuery('body').hasClass('fastfactsupplier') && jQuery('body').hasClass('insert')) {
    // TOGGLE INSERT 
    var toggle = 0;
