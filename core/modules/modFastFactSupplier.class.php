...
/**
 *  \defgroup   fastfact Saisie Rapide de Factures Fournisseurs
 *  \brief      Module permettant la saisie rapide de factures fournisseurs
 *  \file       htdocs/custom/fastfactsupplier/core/modFastFactSupplier.class.php
 *  \ingroup    fastfactsupplier
 *  \brief      Fichier de description et activation du module FastFactSupplier
 */
 ...
 */
class modFastFactSupplier extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300303;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'fastfactsupplier';

        // Family can be 'crm','financial','hr','projects','products','ecm','technic','interface','other'
        // It is used to group modules by family in module setup page
        $this->family = "Progiseize";
        // Module position in the family
        $this->module_position = 120;
        ...
        $this->description = "Permet la saisie rapide des factures fournisseurs.";
        $this->descriptionlong = "Permet la saisie rapide de nouveau tiers et de factures fournisseurs dans l'objectif d'une intégration en comptabilité.";
        ...
        $this->langfiles = array("fastfactsupplier@fastfactsupplier");
        ...
        $serverList = "Assurances,Cadeaux à la clientèle,Charges locatives,Commissions sur achats,Commissions sur ventes,Crédit Bail immobilier,Crédit Bail mobilier,Divers,Documentation générale,Documentation technique,Eau,Electricité,Entretien et réparation sur bien immobilier,Entretien et réparation sur bien mobilier,Etudes et recherches,Fournitures administratives,Fournitures d’entretien,Frais bancaires,Frais de déplacements,Frais de réception,Frais de séminaires,Frais d’actes,Frais internet,Frais postaux,Frais télécommunication,Gaz,Honoraires,Location immobilière,Locations mobilière,Loyers,Maintenance,Médecine du travail,Personnel extérieur, interim,Petit équipement,Publicités,Sous-traitance,Transport";

        $this->const = array(
            0=>array('SRFF_USESERVERLIST','chaine',false,'',1),
            1=>array('SRFF_SERVERLIST','chaine',$serverList,'',1),
            2=>array('SRFF_CATS','chaine','','',1),
            3=>array('SRFF_GOTOREG','chaine',false,'',1),
            4=>array('SRFF_DEFAULT_TVA','chaine','','',1),
            5=>array('SRFF_SHOWEXTRAFACT','chaine',true,'',1),
            6=>array('SRFF_SHOWEXTRAFACTLINE','chaine',true,'',1),
            7=>array('SRFF_AMOUNT_MODE','chaine','ht','',1),
            8=>array('SRFF_BANKACCOUNT','chaine','-1','',1),
        );
        ...
        */
        ...
        $this->rights[$r][4] = 'saisir';             // In php code, permission will be checked by test
        ...
        if($version[0] >= 7): 
            $this->menu[$r]=array('fk_menu'=>'fk_mainmenu=billing,fk_leftmenu=suppliers_bills','type'=>'left','titre'=>'Saisie Rapide Factures Fournisseurs','mainmenu'=>'','leftmenu'=>'','url'=>'/fastfactsupplier/','langs'=>'fastfactsupplier@fastfactsupplier','position'=>1,'enabled'=> '$conf->fastfactsupplier->enabled','perms'=> '$user->rights->fastfactsupplier->saisir', 'target'=>'','user'=>2);
        else: 
